...
echo "     colcon build --packages-select radio_vio"
...
echo "     ros2 launch radio_vio rtl_sdr.launch.py"
echo ""
echo "  4. Launch ADS-B aircraft decoder (dump1090 mode):"
echo "     ros2 launch radio_vio rtl_adsb.launch.py"
echo ""
echo "  5. Launch ADS-B in IQ mode (pyModeS, no dump1090):"
echo "     ros2 launch radio_vio rtl_adsb.launch.py decoder_mode:=iq"
echo ""
